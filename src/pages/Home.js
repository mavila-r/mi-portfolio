      ...
      <div className='Muestras'>
        ...
        <div className='MiniMuestras'>
          <Link to="/pintura-clasica">
            ...
            <div className='ImagenMuestra'><img className="Pintura" src={playa} alt="img ejemplo"/></div>
          </Link>
        </div>
         <div className='MiniMuestras'>
          <Link to="/videojuegos">
            <div className='TituloMuestra'>Videojuegos</div>
            <div className='ImagenMuestra'><img className="Videojuegos" src={playa} alt="img ejemplo"/></div>
          </Link>
        </div>
      </div>
      <h2>¿Quién soy?</h2>
